...
export default function education() {
  return (
    <div className="lg:mt-16 mt-4 lg:ml-40 lg:pl-8 pl-4">
      <div className="flex">
        <div className="pb-1">
          <div className="relative group">
            ...
            <div className="relative flex bg-white rounded-lg lg:p-2 p-2 lg:px-4 px-2">
              <h1 className="font-serif lg:text-4xl text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-black to-black ">
                Education
              </h1>
              <svg
        ...
        <div className="lg:mt-4 mt-2">
          ...
          <div className="lg:pl-2 pl-1">
            ...
            animate-text"
              ...
              <p className="flex ml-10 font-light lg:text-xl">
                Highlights: JS framework - (React, Angular, Express), Rest API,
          ...
          <div className="lg:pl-2 pl-1">
            ...
            animate-text"
              ...
              <p className="ml-10 font-light lg:text-xl">
                Learned everything about Continous integration and development.
              </p>
              <p className="flex ml-10 font-light lg:text-xl">
